                                                        ...
                                                        bool startTransaction)
{
    ...
    const QStringList statements = {
        QStringLiteral("DELETE FROM caldavOutbox WHERE accountID = ? AND localScheduleID IN ("
                       "SELECT localScheduleID FROM caldavEventMapping "
                       "WHERE accountID = ? AND calendarID = ?)"),
        QStringLiteral("DELETE FROM caldavEventMapping WHERE accountID = ? AND calendarID = ?"),
        QStringLiteral("DELETE FROM caldavCategoryMapping WHERE accountID = ? AND calendarID = ?"),
        QStringLiteral("DELETE FROM caldavCalendar WHERE accountID = ? AND calendarID = ?"),
    };
